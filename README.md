...
- Отправка сообщения в Telegram об успешном запуске проекта на рабочем сервере**
    _**у вас должен быть чат с вашим ботом_
...
Добавьте в найстройках к репозитарию следующие Actions secrets:
